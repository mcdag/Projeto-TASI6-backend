...
function serialize_services_report_ListAllReportsRequest(arg) {
  if (
    ...
    throw new Error(
      "Expected argument of type services.report.ListAllReportsRequest"
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function deserialize_services_report_ListAllReportsRequest(buffer_arg) {
  return proto_services_report_report_service_pb.ListAllReportsRequest.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function serialize_services_report_ListAllReportsResponse(arg) {
  if (
    ...
    throw new Error(
      "Expected argument of type services.report.ListAllReportsResponse"
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function deserialize_services_report_ListAllReportsResponse(buffer_arg) {
  return proto_services_report_report_service_pb.ListAllReportsResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
