...
interface IUserServiceService_ISignUp
...
interface IUserServiceService_ILogin
  extends grpc.MethodDefinition<
...
export interface IUserServiceClient {
  signUp(
    request: proto_services_user_user_service_pb.SignUpRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_services_user_user_service_pb.SignUpResponse
    ) => void
  ...
  login(
    request: proto_services_user_user_service_pb.LoginRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: proto_services_user_user_service_pb.LoginResponse
    ) => void
  ): grpc.ClientUnaryCall;
  login(
    request: proto_services_user_user_service_pb.LoginRequest,
