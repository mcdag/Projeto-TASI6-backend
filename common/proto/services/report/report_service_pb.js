...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.services.report.CreateReportRequest.displayName = 'proto.services.report.CreateReportRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.services.report.CreateReportResponse.displayName = 'proto.services.report.CreateReportResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.services.report.ListAllReportsRequest.displayName = 'proto.services.report.ListAllReportsRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.services.report.ListAllReportsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.services.report.ListAllReportsResponse.repeatedFields_, null);
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.services.report.ListAllReportsResponse.displayName = 'proto.services.report.ListAllReportsResponse';
}
 ...
 * @return {!Object}
 */
proto.services.report.Report.prototype.toObject = function(opt_includeInstance) {
 ...
 * @return {!proto.services.report.Report}
 */
proto.services.report.Report.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.report.Report.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Object}
 */
proto.services.report.CreateReportRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.services.report.CreateReportRequest.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.report.CreateReportRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    userId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    report: (f = msg.getReport()) && proto.services.report.Report.toObject(includeInstance, f)
  };
...
proto.services.report.CreateReportRequest.deserializeBinary = function(bytes) {
  ...
  return proto.services.report.CreateReportRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.services.report.CreateReportRequest}
 */
proto.services.report.CreateReportRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      reader.readMessage(value,proto.services.report.Report.deserializeBinaryFromReader);
      msg.setReport(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.services.report.CreateReportRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.report.CreateReportRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.report.CreateReportRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserId();
  if (f.length > 0) {
    writer.writeString(
 ...
 */
proto.services.report.CreateReportRequest.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!proto.services.report.CreateReportRequest} returns this
*/
proto.services.report.CreateReportRequest.prototype.setReport = function(value) {
 ...
 * @return {!Object}
 */
proto.services.report.CreateReportResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.services.report.CreateReportResponse.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.report.CreateReportResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.services.report.CreateReportResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.report.CreateReportResponse;
  return proto.services.report.CreateReportResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.services.report.CreateReportResponse}
 */
proto.services.report.CreateReportResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.report.CreateReportResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.report.CreateReportResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.report.CreateReportResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.services.report.CreateReportResponse.prototype.setCreated = function(value) {
 ...
 * @return {!Object}
 */
proto.services.report.ListAllReportsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.services.report.ListAllReportsRequest.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.report.ListAllReportsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.services.report.ListAllReportsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.report.ListAllReportsRequest;
  return proto.services.report.ListAllReportsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.services.report.ListAllReportsRequest}
 */
proto.services.report.ListAllReportsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.report.ListAllReportsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.report.ListAllReportsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.report.ListAllReportsRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {!Object}
 */
proto.services.report.ListAllReportsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.services.report.ListAllReportsResponse.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.report.ListAllReportsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    reportsList: jspb.Message.toObjectList(msg.getReportsList(),
    proto.services.report.Report.toObject, includeInstance)
  };
 ...
 */
proto.services.report.ListAllReportsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.report.ListAllReportsResponse;
  return proto.services.report.ListAllReportsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.services.report.ListAllReportsResponse}
 */
proto.services.report.ListAllReportsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.report.ListAllReportsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.report.ListAllReportsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.report.ListAllReportsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.services.report.ListAllReportsResponse.prototype.getReportsList = function() {
  return /** @type{!Array<!proto.services.report.Report>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.services.report.Report, 1));
};
...
*/
proto.services.report.ListAllReportsResponse.prototype.setReportsList = function(value) {
 ...
 * @return {!proto.services.report.Report}
 */
proto.services.report.ListAllReportsResponse.prototype.addReports = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.services.report.Report, opt_index);
};
 ...
 * @return {!proto.services.report.ListAllReportsResponse} returns this
 */
proto.services.report.ListAllReportsResponse.prototype.clearReportsList = function() {
